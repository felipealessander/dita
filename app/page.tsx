...
const readyLooks = [
  { title: "Camiseta Performance Preta", audience: "Masculino", setting: "Hybrid", image: "/campaign/linha-pronta/masculino-preto-hybrid.webp", query: "masculino" },
  { title: "Camiseta Performance Azul", audience: "Masculino", setting: "Corrida", image: "/campaign/linha-pronta/masculino-azul-corrida.webp", query: "masculino" },
  { title: "Regata Performance Bordô", audience: "Feminino", setting: "Hybrid", image: "/campaign/linha-pronta/feminino-bordo-hybrid.webp", query: "feminino" },
  { title: "Regata Performance Azul", audience: "Feminino", setting: "Corrida", image: "/campaign/linha-pronta/feminino-azul-corrida.webp", query: "feminino" },
];
  ...
  return (
    <main>
      ...
      <header className="store-header">
        <a className="brand-symbol" href="#inicio" aria-label="Ditá, início">
          <img src="/logo-dita-symbol.jpeg" alt="" />
        </a>
      ...
      <section className="commerce-hero" id="inicio">
        ...
        <div className="hero-copy">
          <span className="hero-mark" aria-hidden="true"><img src="/logo-dita-symbol.jpeg" alt="" /></span><p className="eyebrow">Performance em cada movimento</p>
      ...
      <section className="ready-line" id="linha-pronta" aria-labelledby="linha-pronta-title">
        <div className="section-heading">
          <div><span className="section-kicker">Peças já produzidas</span><h2 id="linha-pronta-title">A performance <em>ganhou forma.</em></h2></div>
          <p>Visualizações editoriais criadas a partir das peças reais da Ditá.</p>
        </div>
        <div className="ready-grid">
          {readyLooks.map((look) => (
            <a className="ready-card" href={storeUrl("search/?q=" + look.query, "linha_pronta_" + look.query)} key={look.title}>
              <div className="ready-image"><img src={look.image} alt={look.title + " Ditá em atleta " + look.audience.toLowerCase()} /></div>
              <div className="ready-meta"><span>{look.audience} · {look.setting}</span><h3>{look.title}</h3><b>Conhecer na loja <Arrow /></b></div>
            </a>
          ))}
        </div>
      </section>
      ...
      <footer className="store-footer">
        <div className="footer-brand"><span className="brand-symbol" aria-hidden="true"><img src="/logo-dita-symbol.jpeg" alt="" /></span><h2>Ditando<br /><em>o movimento.</em></h2><div className="footer-social">Instagram · WhatsApp</div></div>
